...
\noindent Snow avalanches are snow masses that descend slopes \citep{schweizerSnowAvalancheFormation2003}. Snow avalanches can occur in different types, such as snow slab avalanches, where a slab of snow slides \citep{gaumeSnowFractureRelation2017}. Such avalanches are among the most prominent hazards in mountainous regions \citep{gaumeSnowFractureRelation2017}, they can be triggered by rapid loading near the surface, for example by a person skiing over them, or by a dynamite source \citep{schweizerSnowAvalancheFormation2003}. The cracks caused by this propagate and eventually lead to material failure , the release of the slab is caused by an increase of shear stress in a weak layer in the snowpack \citep{habermannInfluenceSnowpackLayering2008}. \\
...
\newpage   
\typeout{}
\bibliographystyle{apa-good-doi.bst}
\bibliography{reserachmodule_agp_bib}
