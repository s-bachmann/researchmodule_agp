...
\noindent Furthermore, the medium properties in table \ref{tab:material_properties} also show a strong contrast in density \rho between all three mediums. According to the formulations of wave speed described by \cite{AkiRichards2002} and \cite{dennemanReflectionTransmissionWaves2002}, where \ref{P_wave_fluid} describes the speed of a p-wave in a pure acoustic medium, \ref{P_wave_speed} the p-wave speed with Lamé-parameters \lambda  and \rho and \ref{s_wvae_speed} describes the s-wave speed. 
\begin{subequations}
    \label{Wavespeeds}
        \begin{equation}
            \label{P_wave_fluid}
