...
\section{Appendix}
\noindent The animations for the wavefield propagation of each source type can be found on polybox: https://polybox.ethz.ch/index.php/s/97aa3x2o2FtnMS5  \\

\noindent The full code for all simulations run is stored on the github repository: https://github.com/s-bachmann/researchmodule_agp
